...
{
    public class ZapinatorChanged : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (Main.rand.Next(12) == 0)
            {
                ...
                Projectile.NewProjectile(source, Projectile.Center, velocity*1.25f, ModContent.ProjectileType<ZapinatorChanged>(), 300, 1f, Main.myPlayer);
            }
            ...
            {
                target.AddBuff(153, (int)((float)Main.rand.Next(1, 1000) * 1.1f));
            }
            ...
            {
                target.AddBuff(67, 750);
                target.AddBuff(67, 750);
                target.AddBuff(24, 750);
                target.AddBuff(24, 750);
                target.AddBuff(67, 750);
                target.AddBuff(67, 750);
                target.AddBuff(24, 750);
